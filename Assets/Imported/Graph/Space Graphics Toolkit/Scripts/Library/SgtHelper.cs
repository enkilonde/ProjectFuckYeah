...
public static partial class SgtHelper
{
	...
	public const string GameObjectMenuPrefix = "GameObject/Create Space Graphics Toolkit/";
	...
	public static void DestroyManaged(System.Action DestroyAction)
	{
		if (DestroyAction != null)
		{
			...
			//if (Application.LoadLevelAsync(0) == false)
			{
	...
	public static void CalculateLight(Light light, Vector3 center, Transform directionTransform, Transform positionTransform, ref Vector3 position, ref Vector3 direction, ref Color color)
	{
		if (light != null)
		{
			...
			color     = SgtHelper.Brighten(light.color, light.intensity * 2.0f);
