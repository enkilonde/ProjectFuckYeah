...
{
	public static float maxVelocityMagnitude;
	[Range(1f, 50f)]
	[Header("Etirement maximum de l'effet NOVA (non editable en realtime)")]
	public float maxStartFieldStretch = 10f;
	...
	{
		//TODO C'est moi là
		SgtObserver.maxVelocityMagnitude = maxStartFieldStretch;
